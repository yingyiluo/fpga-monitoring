...
//local attribute for later version: numreadports(7))
//__attribute__((local_mem_size(2048))) __local : only can have local argument with null pointer 
...
//			printf("IN n: %d E = %lf ll = %ld, ul = %ld\n", n, p_energy, ll, ul);
		}

		SearchContext sc = {p_energy, ll, ul, mat};
		
//		printf("STAGE_NUM: %d E = %lf ll = %ld, ul = %ld\n", STAGE_NUM, p_energy, ll, ul);
    		write_channel_altera(SC_QUEUE[0], sc);
    }
}

#include "GridSearch_nochannel_unroll12.cl"
#include "Reader_nochan.cl"
