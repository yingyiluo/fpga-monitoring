...
__kernel void simulation(int lookups)
{
	...
	for( int i = 0; i < lookups; i++ )
	{
		...
		for (int n = 0; n < STAGE_NUM; n++) {
			...
			//printf("ul: %ld, ll: %ld, d: %lf, cmid: %d, index: %ld\n", ul, ll, cache_data.data.d, cmid, cache_data.index );
		}
...
#include "GridSearch_nochannel_nounroll.cl"
#include "CalculateXS_8_d16_nochannel.cl"
